...
/*   Updated: 2026/03/01 20:03:59 by jenlee           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
extern int g_exit_status; //Need to add as struct member, or can ignore if status member is added
...
int 			run_builtin_parent(t_ast_node *ast, t_minishell *minishell); //from t_env to t_minishell
int 			is_builtin(char *cmd);
